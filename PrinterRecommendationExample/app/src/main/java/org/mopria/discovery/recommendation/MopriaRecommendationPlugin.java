...
package org.mopria.discovery.recommendation;
...
public class MopriaRecommendationPlugin extends ServiceRecommendationPlugin {
    ...
    public MopriaRecommendationPlugin(Context context) {
        super(context, R.string.plugin_vendor_morpia, new VendorInfo(context.getResources(), R.array.known_print_vendor_info_for_mopria), new String[]{"_ipp.tcp", "_ipps._tcp"});
    }
