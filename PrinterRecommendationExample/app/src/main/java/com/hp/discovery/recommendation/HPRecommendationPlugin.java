...
*/
package com.hp.discovery.recommendation;
...
public class HPRecommendationPlugin extends ServiceRecommendationPlugin {
    ...
    public HPRecommendationPlugin(Context context) {
        super(context, R.string.plugin_vendor_hp, new VendorInfo(context.getResources(), R.array.known_print_vendor_info_for_hp), new String[]{"_pdl-datastream._tcp","_ipp.tcp", "_ipps._tcp"});
    }
